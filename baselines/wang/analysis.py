...
def run(root, provenance):
    ...
    for temp in TEMPERATURES:
        ...
        for name in LABELS:
            ...
            summary.append(
                dict(
                    ...
                    role=(
                        "primary"
                        if name in ("wang_published", "posterior_standard")
                        else "matched-FPR"
                    ),
                    N=int(wi.sum()),
        ...
        for role, a, b in [
            ("primary", "wang_published", "posterior_standard"),
