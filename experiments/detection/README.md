...
For the Wang comparison, use `python -m experiments.detection.wang_comparison` with `prepare`, `generate`, or `analyze`; `--help` lists the arguments. Its model checksums and design are in `baselines/wang/`.
