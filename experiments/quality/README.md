...
```sh
python -m experiments.quality.run --benchmark gsm8k --model-directory /cache/models/Qwen3-0.6B --artifact /data/artifact.pt --batch-size 8 --seed 12345 --output /results/quality/gsm8k
```
