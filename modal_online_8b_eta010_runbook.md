...
authoritative audit `ap-ExraUnESUNvGB7wfdgKONu`. Settled provider billing
before workspace credits was `$4.75144472`: `$4.61323391` H100,
`$0.11516370` CPU, and `$0.02304711` memory.
