...
MODEL_REVISION = os.environ.get("PRC_MODEL_REVISION") or None
...
if CHOOSE_MODEL == "0.6B":
    ...
    repo_dir = snapshot_download(repo_id=repo_id, local_dir=local_dir, revision=MODEL_REVISION)
...
# Pinned runs use the verified local tokenizer; legacy callers keep their loader.
tok = AutoTokenizer.from_pretrained(
    str(local_dir) if MODEL_REVISION else 'Qwen/Qwen3-0.6B',
